...
pub struct TakeOffer<'info> {
    ...
    #[account(
        init_if_needed, //create PDA accounts only if they don’t already exist
        payer = taker,
        associated_token::mint = token_mint_a,
        associated_token::authority = taker, //account level
    ...
    #[account(
        mut,
        close = maker,  //when close return SOL to the maker
        has_one = maker,
    ...
    #[account(
        mut,
        associated_token::mint = token_mint_b,
        associated_token::authority = offer,  //offer will be the owner of the vault
        associated_token::token_program = token_program,
    )]
